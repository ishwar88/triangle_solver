...
function drawtrimobile() {
    ...
    if ((Math.pow(cmobile, 2)) + (Math.pow(bmobile, 2)) < (Math.pow(amobile,
        2))) {
        alert(
            "Le triangle ne peut pas être dessiné dans ce configuration en utilisant css. Le triangle va être pivoté dans le sens antihoraire."
        );
        drawobtamobile();
    } else if ((Math.pow(cmobile, 2)) + (Math.pow(amobile, 2)) < (Math.pow(
        bmobile, 2))) {
        alert(
            "Le triangle ne peut pas être dessiné dans ce configuration en utilisant css. Le triangle va être pivoté dans le sens horaire."
        );
        drawobtbmobile();
    } else {
        drawmobile();
