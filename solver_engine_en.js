...
function drawobta() {
    ...
    if (a2 !== 0) {
        if ((Math.pow(c2, 2)) + (Math.pow(b2, 2)) < (Math.pow(a2, 2))) {
            alert("The second triangle will be rotated counterclockwise");
            h2 = (Math.sin(t2)) * c2;
            ...
            alert("The second triangle will be rotated clockwise");
            h2 = (Math.sin(g2)) * a2;
...
function drawtri() {
    ...
    if ((Math.pow(c, 2)) + (Math.pow(b, 2)) < (Math.pow(a, 2))) {
        alert("The triangle will be rotated counterclockwise");
        drawobta();
    } else if ((Math.pow(c, 2)) + (Math.pow(a, 2)) < (Math.pow(b, 2))) {
        alert("The triangle will be rotated clockwise");
        drawobtb();
    } else {
        draw();
    }
